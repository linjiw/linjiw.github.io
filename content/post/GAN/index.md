...
{{< figure src="./data/cat_10deluxe_instance_dc_cycle_naive/sample-001000-X-Y.png" style="max-width: 20%;" title="sample X to Y: cat_10deluxe_instance_dc_cycle_naive, iter = 1000" > }}
